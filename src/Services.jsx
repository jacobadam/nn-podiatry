...
export default function Services() {
  return (
    <>
      ...
      >
        <div className="grid gap-6 sm:grid-cols-2 lg:mt-2 lg:grid-cols-3 xl:grid-cols-4">
          {services.map((service) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col px-5 pb-5 pt-1 text-center">
                ...
                <span className="mt-6 inline-flex min-h-11 items-center justify-center self-center rounded-lg bg-cyan-600 px-6 py-3 text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition hover:shadow-lg hover:shadow-blue-500/40">
                  Learn more
                </span>
              </div>
            </a>
