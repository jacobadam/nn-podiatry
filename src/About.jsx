export default function About() {
  return (
    <div className="flex items-center justify-center px-4 py-8 sm:px-6 md:px-8 lg:px-12 xl:px-12">
      <section
        className="mx-auto max-w-full rounded-lg bg-gray-50 px-4 py-8 shadow-lg sm:max-w-xl sm:px-6 md:max-w-3xl md:px-8 lg:max-w-4xl lg:px-10 xl:max-w-4xl xl:px-12"
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <p>
                ...
                I lectured at the college before relocating to Liverpool.
              </p>
              ...
              <p>
                ...
                ICI in Runcorn and Widnes (1981-1985), and as the podiatrist for
                Liverpool Football Club (1991-1994).
              </p>
