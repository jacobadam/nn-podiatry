        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base leading-7 text-cyan-100 sm:text-lg">
              Professional foot care, treatment, and preventative support for a
          ...
          <div className="order-2 lg:order-1">
            <div className="mx-auto max-w-2xl lg:mx-0">
              <div className="space-y-4 text-sm leading-7 text-gray-600 sm:text-base sm:leading-8">
                <p id="podiatry-intro">
                  Podiatry (or chiropody) is the medical speciality of caring
                  for feet. The terms podiatry and chiropody are
                  interchangeable, although there are a growing number of
                  surgical podiatrists in the UK who carry out ambulatory foot
                  surgery to treat conditions such as bunions and hammer toes.
                </p>
                ...
                <p id="podiatry-treatments">
                  ...
                  procedure performed under local anaesthetic. This treatment
                  can usually be carried out in the clinic and typically takes
                  less than an hour. Podiatrists also treat verrucae (plantar
                  warts), although the British Medical Association currently
                  advises not treating them unless they are causing pain.
                </p>

                <p id="podiatry-diabetics">
                  Podiatrists also care for the feet of people with diabetes.
                  Due to the effects diabetes can have on the feet, individuals
                  are at greater risk of peripheral vascular disease
                  (circulatory problems) and peripheral neuropathy, which
                  reduces sensation in the feet. Without proper care, diabetics
                  have a higher risk of serious foot complications, many of
                  which can be prevented through regular podiatry treatment.
                </p>
              </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="mx-auto max-w-xl lg:ml-auto lg:max-w-none">
              <div className="overflow-hidden rounded-3xl border border-gray-200 bg-gray-100 shadow-lg">
                <img
                  className="aspect-4/3 w-full object-cover opacity-80 lg:aspect-5/6"
                  src="/footcare.webp"
                  alt="footcare"
                />
              </div>
