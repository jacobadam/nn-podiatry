              ...
              <div className="mx-auto max-w-2xl text-center">
                <div className="mx-auto max-w-2xl space-y-6 text-center sm:text-left">
                  ...
                  >
                    ...
                    ambulatory foot surgery on patients to treat conditions such
                    as bunions and hammer toes).
                  </p>
                  <p
                    className="text-base font-normal text-gray-500"
                  ...
                  >
                    ...
                    ingrowing toenails which can be cured by way of a minor
                    surgical procedure under a local anaesthetic - a procedure
                    that can be carried out in the surgery and takes less than
                    an hour). Podiatrists also treat verrucae (plantar warts)
                    although the present advice of the BMA (British Medical
                    Association) is to not treat verrucae unless they are
                    causing pain. Painful verrucae can still be treated by
                    podiatrists.
                  </p>
                  <p
                    className="text-base font-normal text-gray-500"
